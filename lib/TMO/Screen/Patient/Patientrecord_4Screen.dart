...
class Patientrecord4screen extends StatefulWidget {
  const Patientrecord4screen({super.key});

  @override
  State<Patientrecord4screen> createState() => _Patientrecord4screenState();
}

class _Patientrecord4screenState extends State<Patientrecord4screen> {
  ...
  Future<void> _handleImageSelection(PatientRecordModel photo, ImageSource source) async {
